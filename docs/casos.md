...
Esta guía nació como suplemento de cuatro estudios hechos **100 % con datos satelitales gratuitos**.
...
!!! note "El hilo común"
    Los cuatro parten de la misma pregunta —**¿qué quiero medir?**— y de ahí derivan sensor, banda y
    técnica. Y los cuatro son **honestos con el límite del método**: a veces el resultado más valioso
